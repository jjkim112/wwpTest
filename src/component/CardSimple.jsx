...
const CardSimple = ({ shape, number, isPick, isOriginCard }) => {
  return isPick ? (
    <div
      className={`relative w-12 h-16 border-2 rounded-md text-lg text-gray-400 ${
        isOriginCard ? "border-2 border-red-500 hover:cursor-pointer" : null
      }`}
    >
    ...
    <div className="relative w-12 h-16 border-2 rounded-md hover:cursor-pointer text-lg">
